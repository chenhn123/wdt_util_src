...
int wh_w8755_dev_get_indexed_string(WDT_DEV* pdev, UINT32 index, BYTE* buf, UINT32 buf_size)
{
	if (!pdev)
		return 0;
...
int wh_w8755_dev_set_basic_op(WDT_DEV *pdev)
{
	...
	g_func_dev_basic.p_wh_get_index_string = wh_w8755_dev_get_indexed_string;
